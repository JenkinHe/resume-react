...
export default function TechSkillsCard({ skillItem }) {
    return <div className="flex flex-row w-96 overflow-hidden p-5 bg-white/75 shadow-xl gap-5 border-2 rounded=2xl border-white">
        <div className="h-40 justify-center overflow-hidden items-contain rounded-xl">
